...
#Create variable for every function we are going to use
class DB:
    def __init__(self):
    ...
    #The part that is needed for the assignment to be completed
    def show_db(self):
...
# Use the definitions to complete the program
